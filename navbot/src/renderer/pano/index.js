...
(function () {
  ...
  var scenes = data.scenes.map(function (data) {
    // var urlPrefix = "tiles/bursar";
    var urlPrefix = customUrlPrefix;
  ...
  // Function to switch to the next scene after 5 seconds
  function switchToNextScene() {
    currentSceneIndex = (currentSceneIndex + 1) % scenes.length;
    switchScene(scenes[currentSceneIndex]);
    setTimeout(switchToNextScene, 5000); // 5 seconds delay
  }
